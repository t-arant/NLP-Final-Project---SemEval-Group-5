from bioes_opinion_aspect_label_gen_separate import *
...
tkr = "bert-base-multilingual-cased"
for lang in langs:
        ...
        if (lang == "eng") or (lang == "zho"):
            ...
            for domain in domain1: 
                ...
                f_name = f"subtask_2_{lang}_{domain}_sep.json"
                ...
                generate_BIOES_labels(lang, task, subtask, domain, tkr, "bioes", f_name, max_len)
