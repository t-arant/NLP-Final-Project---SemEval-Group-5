...
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/eng_laptop_distilbert_comb.csv 
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/zho_laptop_distilbert_comb.csv 
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/eng_restaurant_distilbert_comb.csv 
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/rus_restaurant_distilbert_comb.csv 
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/tat_restaurant_distilbert_comb.csv 
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/ukr_restaurant_distilbert_comb.csv 
# /home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/zho_restaurant_distilbert_comb.csv

eng_lap = pd.read_csv("/home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/eng_laptop_distilbert_comb.csv", index_col=0)
eng_rest = pd.read_csv("/home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/eng_restaurant_distilbert_comb.csv", index_col=0)
zho_lap = pd.read_csv("/home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/zho_laptop_distilbert_comb.csv", index_col=0)
zho_rest = pd.read_csv("/home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/zho_restaurant_distilbert_comb.csv", index_col=0)
rus_rest = pd.read_csv("/home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/rus_restaurant_distilbert_comb.csv", index_col=0)
tar_rest = pd.read_csv("//home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/tat_restaurant_distilbert_comb.csv", index_col=0)
ukr_rest = pd.read_csv("/home/tony-arant/NLP Final Project/data_labs/single_asp_opn/distilbert/ukr_restaurant_distilbert_comb.csv", index_col=0)
...
eng_lap.to_json("distilbert_subtask_2_eng_laptop_comb.json", orient="records", lines=True)
eng_rest.to_json("distilbert_subtask_2_eng_restaurant_comb.json", orient="records", lines=True)
zho_lap.to_json("distilbert_subtask_2_zho_laptop_comb.json", orient="records", lines=True)
zho_rest.to_json("distilbert_subtask_2_zho_restaurant_comb.json", orient="records", lines=True)
rus_rest.to_json("distilbert_subtask_2_rus_restaurant_comb.json", orient="records", lines=True)
tar_rest.to_json("distilbert_subtask_2_tat_restaurant_comb.json", orient="records", lines=True)
ukr_rest.to_json("distilbert_subtask_2_ukr_restaurant_comb.json", orient="records", lines=True)
